...
<link rel="stylesheet" type="text/css" href="<?php echo WEBSITE_CSS_URL; ?>jquery.mCustomScrollbar.css" />
...
<script>
var mainApp = angular.module('mainApp',['ngSanitize'], function($interpolateProvider) {
...
<div class="preloader web-loader">
...
?>
<body ng-app="mainApp" class="<?php echo $bodyClass; ?>">

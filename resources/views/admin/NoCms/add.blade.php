...
<section class="content-header">
	...
	<ol class="breadcrumb">
		...
		<li class="active">{{ trans("Add Seo Page") }} </li>
	</ol>
</section>
<section class="content"> 
		...
		<div class="col-md-6">
			<div class="form-group <?php echo ($errors->first('page_id')) ? 'has-error' : ''; ?>">
				...
				<div class="mws-form-item">
					{{ Form::text('page_id','',['class' => 'form-control']) }}
			...
			<div class="form-group <?php echo ($errors->first('meta_description')) ? 'has-error' : ''; ?>">
				...
				<div class="mws-form-item">
					{{ Form::textarea('meta_description','',['class' => 'form-control','rows'=>false,'cols'=>false]) }}
					<div class="error-message help-inline">
			...
			<div class="form-group <?php echo ($errors->first('meta_keywords')) ? 'has-error' : ''; ?>">
				...
				<div class="mws-form-item">
					{{ Form::textarea('meta_keywords','',['class' => 'form-control','rows'=>false,'cols'=>false]) }}
					<div class="error-message help-inline">
	...
	<div class="mws-button-row">
		<div class="input" >
			...
			<a href="{{route($modelName.'.add')}}" class="btn btn-primary"><i class=\"icon-refresh\"></i> {{ trans("messages.user_management.reset") }}</a>

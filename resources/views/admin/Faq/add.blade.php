...
<div class="row pad"> 
	...
	<div class="row pad">
		<div class="col-md-6">	
			...
			@endif
			{{ Form::open(['role' => 'form','route' => 'Faq.add','class' => 'mws-form']) }}
			<div class="form-group <?php echo ($errors->first('category_id')) ? 'has-error' : ''; ?>">
				<div class="mws-form-row">
					...
					<div class="mws-form-item">
						{{ Form::select('category_id',array(''=>'Select Category')+$listDownloadCategory,'null',['class' => 'form-control']) }}
			...
			<div class="mws-panel-body no-padding tab-content"> 
				...
				<div class="mws-button-row">
					...
					<a href="{{route('Faq.add')}}" class="btn btn-primary reset_form"><i class=\"icon-refresh\"></i> {{ trans('Clear')  }}</a>

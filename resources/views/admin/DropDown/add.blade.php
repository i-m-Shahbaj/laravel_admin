...
<div class="row pad"> 
	...
	<div class="row pad">
		<div class="col-md-6">	
			...
			{{ Form::open(['role' => 'form','route' => ['DropDown.add',$type],'class' => 'mws-form','files' => true]) }}	
				...
				<div class="mws-panel-body no-padding tab-content"> 
					...
					<div class="mws-button-row">
						...
						<a href="{{route('DropDown.add',$type)}}" class="btn btn-primary"><i class=\"icon-refresh\"></i> {{ trans('Reset')  }}</a>

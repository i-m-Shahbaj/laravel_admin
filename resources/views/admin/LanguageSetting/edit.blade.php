...
{{ Form::open(['role' => 'form','route' => ["$modelName.edit",$Id],'class' => 'mws-form','id'=>'LanguageSettingEditForm']) }}
		
			<div class="mws-form-inline">
				<div class="mws-form-row">
					<div class="mws-form-item">
					<div class="controls" style="margin-left:0px;margin-bottom:0px;">
						{{ Form::text('word', $result->msgstr, ['class' => 'small','style'=>"height:30px;width:200px;font-size:9pt;",'id'=>'edit_msgstr']) }}
